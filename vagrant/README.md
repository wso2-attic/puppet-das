...
1. Clone WSO2 DAS Puppet modules Git repository and consider this path as `PUPPET_HOME`:

    ````
    git clone https://github.com/wso2/puppet-das.git
    ````
...
5. Download and copy WSO2 DAS distribution (3.0.0 or 3.0.1) to Puppet module under `files` folder:

    ````
    <PUPPET_HOME>/modules/wso2das/files
    ````
